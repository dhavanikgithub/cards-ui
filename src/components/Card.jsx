...
const Card = ({ id, bgColor, brColor, mainColor }) => {
    return (
        <div className={`container`} style={{ backgroundColor: `${bgColor}`, border: `3px solid ${brColor}` }}>
            <div className="content">
                <h1 className="ff-Outfit fw-600 fs-normal card-title">{id} AI image enhancer</h1>
                <p className="ff-Manrope fs-normal fw-400">
                    Level up your image game! Our AI can expand images, change backgrounds, and turn any image into hi-fi or vector.
                </p>
                <button className={`button ff-Manrope fw-700 fs-normal btn-br-color`} style={{ backgroundColor: `${bgColor}`, border: `1px solid ${brColor}`}}>
                    Enter playground
                </button>
