    ...
    return (
        <div className={`container`} style={{ background: `linear-gradient(to top, ${linerGradientStartColor}, ${linerGradientEndColor})`, boxShadow: 'rgba(0, 0, 0, 0.10) 0px 20px 40px' }}>
            <div className="content">
                ...
                <button className={`button ff-Manrope fw-700 fs-normal `} style={{ color: `${contentTextColor}`, backgroundColor: linerGradientStartColor, border: 'none', boxShadow: 'rgba(0, 0, 0, 0.1) 0px 10px 20px' }}>
                    Enter playground
                </button>
